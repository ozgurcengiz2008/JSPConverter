...
import vlc
instance = vlc.Instance('C:\Program Files\VideoLAN\VLC')
...
class Anasayfa(QMainWindow, Ui_MainWindow):
    ...
    def on_download_finished(self, output_file):
        ...
        if output_file:
            ...
            # İlk olarak çeviriyi yapın:
            message = QCoreApplication.translate("Anasayfa", "İndirme işlemi başarısız oldu.")

            # Sonra bir QMessageBox oluşturun ve mesajı gösterin:
            QMessageBox.warning(self, QCoreApplication.translate("Anasayfa", "Uyarı"), message, QMessageBox.Ok)
